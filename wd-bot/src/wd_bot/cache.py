...
class AppCommandCache:
    ...
    _global_app_commands: ClassVar[CommandStore] = {}
    _guild_app_commands: ClassVar[dict[int, CommandStore]] = {}
    ...
    def get_app_command(
        ...
        *,
        ...
        def search_dict(d: CommandStore) -> Mentionable | None:
    ...
    def _unpack_app_commands(self, commands: list[AppCommand]) -> CommandStore:

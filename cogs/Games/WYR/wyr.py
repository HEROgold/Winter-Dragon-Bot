...
class Wyr(commands.Cog):
    ...
    async def Wyr(self, ctx): # get json database for game id number.
        ...
        emb = discord.Embed(title=f"Would You Rather Question #{id}", description=question, color=discord.Color.from_rgb(r,g,b)) # set random color for embed based on values r, g ,b

...
# -------------
    ...
    async def on_invite_create(self, entry: discord.AuditLogEntry) -> None:
        ...
        await self.send_channel_logs(invite.guild, embed, LogCategories.INVITE_CREATE)
    ...
    async def on_invite_update(self, entry: discord.AuditLogEntry) -> None:
        ...
        await self.send_channel_logs(invite.guild, embed, LogCategories.INVITE_UPDATE)
    ...
    async def on_invite_delete(self, entry: discord.AuditLogEntry) -> None:
        ...
        await self.send_channel_logs(invite.guild, embed, LogCategories.INVITE_DELETE)
...
# -----------------------------------------
    ...
    async def on_app_command_permission_update(self, entry: discord.AuditLogEntry) -> None:
        ...
        target: discord.PartialIntegration | app_commands.AppCommand = entry.target

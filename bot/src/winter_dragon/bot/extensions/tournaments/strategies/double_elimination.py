...
class DoubleEliminationStrategy(TournamentStrategy):
    ...
    def validate_team_count(self, team_count: int) -> bool:
        ...
        return team_count >= 4 and (team_count & (team_count - 1)) == 0
    ...
    async def advance_to_next_round(self, completed_matches: list[TournamentMatch]) -> list[TournamentMatch]:
        ...
        lb_matches = [m for m in current_round_matches if m.bracket_position and m.bracket_position.startswith("LB")]

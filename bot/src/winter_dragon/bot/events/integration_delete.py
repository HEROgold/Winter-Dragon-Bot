...
class IntegrationDelete(AuditEvent, action=AuditLogAction.integration_delete):
    """Handle integration delete events."""

    @override
    async def handle(self) -> None:
        # https://discordpy.readthedocs.io/en/stable/api.html?highlight=auditlogentry#discord.AuditLogAction.integration_delete
        self.logger.debug(f"on integration_delete: {self.entry.guild=}, {self.entry=}")

...
class IntegrationCreate(AuditEvent, action=AuditLogAction.integration_create):
    """Handle integration create events."""

    @override
    async def handle(self) -> None:
        # https://discordpy.readthedocs.io/en/stable/api.html?highlight=auditlogentry#discord.AuditLogAction.integration_create
        self.logger.debug(f"on integration_create: {self.entry.guild=}, {self.entry=}")
